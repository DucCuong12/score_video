...
def build_groundingdino(args):
    ...
    # Respect external config/CLI override instead of forcing a local checkpoint path.
    bert_base_uncased_path = getattr(args, "bert_base_uncased_path", "bert-base-uncased")
    if not bert_base_uncased_path:
