...
- In this case, event completion should not be considered reliable even if outcomes appear correct.
...
def get_prompt_fields(prompt_info):
    ...
    event_list = prompt_info.get("event_list", [])
    ...
    return view, description, event_list, robotic_manipulator, manipulated_object
...
def process_single_image_gpt(args_tuple):
    ...
    try:
        ...
        view, description, event_list, robotic_manipulator, manipulated_object = get_prompt_fields(prompt_info)
